        ...
        <div class="col-12 col-lg-6 text-center fw-bold border">
            <div class="row g-0">
                ...
                <div class="col-12 px-4 pb-4">
                    <form action="{{ url('admin/warehouse/categoryitem') }}" method="POST" class="garvice-content-form">
                        @csrf
                        ...
                        <div class="d-flex justify-content-end">
                            <a href="{{ url('admin/warehouse/categoryitem') }}" class="btn btn-white border text-secondary garvice-content-form-link me-4 rounded-0">Cancel</a>
