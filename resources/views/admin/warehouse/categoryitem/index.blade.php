...
<div class="col-12 col-lg-10 g-0 border garvice-content">
    <div class="row g-0">
        ...
        <a href="{{ url('admin/warehouse/categoryitem/create') }}" class="border text-decoration-none text-dark col-4 col-sm-4 text-center py-3 fw-bold garvice-content-link-add">
                ...
                <tbody class="text-secondary">
                    ...
                    <tr>
                        ...
                        <td class="text-center py-3">
                            <a class="px-1 text-decoration-none" href="{{ url('admin/warehouse/categoryitem', $category->id) }}/edit"><i class="bi bi-pen garvice-content-table-icon-edit"></i></a>
                        </td>
                        <td>
                            <form action="{{ url('admin/warehouse/categoryitem', $category->id) }}" method="POST">
                                @csrf
                                @method("DELETE")
