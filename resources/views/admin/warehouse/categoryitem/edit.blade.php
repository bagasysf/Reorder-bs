        ...
        <div class="col-12 col-lg-6 text-center fw-bold border">
            <div class="row g-0">
                ...
                <div class="col-12 px-4 pb-4">
                    <form action="{{ url('admin/warehouse/categoryitem', $categoryid->id) }}" method="POST" class="garvice-content-form">
                        @csrf
                        @method("PUT")
                        ...
                        <div class="d-flex justify-content-end">
                            <a href="{{ url('admin/warehouse/categoryitem') }}" class="btn btn-white border text-secondary me-4 rounded-0 garvice-content-form-link">Cancel</a>
